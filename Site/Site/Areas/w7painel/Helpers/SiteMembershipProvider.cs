...
namespace Site.Areas.w7painel.Helpers
{
    public class SiteMembershipProvider : MembershipProvider
    {
        ...
        public override bool ValidateUser(string username, string password)
        {
            ...
            //para criptografar a senha basta trocar o password pela hash na busca abaixo

            return contexto.Usuarios.Any(user => (user.Login == username.Trim()) && (user.Pass == password));
        }
